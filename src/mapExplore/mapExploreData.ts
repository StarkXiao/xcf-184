import type { Region, BuildingCluster, RareAirCurrent, StoryEvent, Stage, MapExploreState, RegionProgress } from './types';
...
export const BUILDING_CLUSTERS: BuildingCluster[] = [
  {
    ...
    icon: '🏪', position: { x: 130, y: 300 }, unlockCost: 0, buildingCount: 8, minHeight: 12, maxHeight: 25, rewardCoins: 30,
  },
  {
    id: 'bc_temple_roof', regionId: 'region_old_town', name: '古庙飞檐', description: '高耸的寺庙屋顶，檐角形成了独特的上升气流',
    icon: '🏯', position: { x: 180, y: 260 }, unlockCost: 50, buildingCount: 4, minHeight: 25, maxHeight: 40, specialEffect: 'updraft_boost', rewardCoins: 60,
  },
  {
    id: 'bc_alley_network', regionId: 'region_old_town', name: '巷道迷网', description: '错综复杂的窄巷系统，考验转向和操控能力',
    icon: '🏘️', position: { x: 160, y: 320 }, unlockCost: 80, buildingCount: 12, minHeight: 10, maxHeight: 20, specialEffect: 'narrow_passage', rewardCoins: 50,
  },
  {
    id: 'bc_river_towers', regionId: 'region_riverside', name: '河滨双塔', description: '河畔矗立的现代化双子塔，塔间风道气流强劲',
    icon: '🏙️', position: { x: 370, y: 200 }, unlockCost: 0, buildingCount: 2, minHeight: 50, maxHeight: 80, specialEffect: 'wind_tunnel', rewardCoins: 80,
  },
  {
    id: 'bc_bridge_arch', regionId: 'region_riverside', name: '拱桥走廊', description: '横跨河流的古老石拱桥，桥下暗藏上升气流',
    icon: '🌉', position: { x: 400, y: 240 }, unlockCost: 100, buildingCount: 3, minHeight: 20, maxHeight: 35, specialEffect: 'bridge_updraft', rewardCoins: 70,
  },
  {
    id: 'bc_dock_district', regionId: 'region_riverside', name: '码头仓库区', description: '沿河分布的低矮仓库和码头设施',
    icon: '⚓', position: { x: 420, y: 270 }, unlockCost: 120, buildingCount: 6, minHeight: 15, maxHeight: 28, rewardCoins: 60,
  },
  {
    id: 'bc_mountain_temple', regionId: 'region_mountain_peak', name: '山巅古寺', description: '矗立于山巅的古老寺院，是热气流汇聚之地',
    icon: '⛩️', position: { x: 260, y: 60 }, unlockCost: 0, buildingCount: 3, minHeight: 30, maxHeight: 50, specialEffect: 'thermal_focus', rewardCoins: 100,
  },
  {
    id: 'bc_cliff_village', regionId: 'region_mountain_peak', name: '悬崖村落', description: '依附悬崖而建的村落，飞行路径险峻',
    icon: '🏔️', position: { x: 300, y: 90 }, unlockCost: 150, buildingCount: 7, minHeight: 15, maxHeight: 35, specialEffect: 'cliff_wind', rewardCoins: 90,
  },
  {
    id: 'bc_peak_station', regionId: 'region_mountain_peak', name: '顶峰观测站', description: '山脉最高处的气象观测站，可遭遇最强烈气流',
    icon: '📡', position: { x: 280, y: 40 }, unlockCost: 200, buildingCount: 2, minHeight: 40, maxHeight: 60, specialEffect: 'peak_turbulence', rewardCoins: 120,
  },
  {
    id: 'bc_factory_row', regionId: 'region_industrial', name: '厂房列阵', description: '排列整齐的工业厂房，屋顶排放的热气形成稳定上升流',
    icon: '🏭', position: { x: 550, y: 370 }, unlockCost: 0, buildingCount: 5, minHeight: 20, maxHeight: 35, specialEffect: 'heat_updraft', rewardCoins: 80,
  },
  {
    id: 'bc_chimney_alley', regionId: 'region_industrial', name: '烟囱小巷', description: '密集烟囱产生的多股独立上升气流',
    icon: '🗼', position: { x: 580, y: 340 }, unlockCost: 120, buildingCount: 8, minHeight: 30, maxHeight: 55, specialEffect: 'multi_updraft', rewardCoins: 100,
  },
  {
    id: 'bc_steel_bridge', regionId: 'region_industrial', name: '钢铁大桥', description: '巨大的工业钢桥，桥梁结构间暗藏风洞',
    icon: '🏗️', position: { x: 540, y: 310 }, unlockCost: 160, buildingCount: 4, minHeight: 25, maxHeight: 45, specialEffect: 'bridge_tunnel', rewardCoins: 90,
  },
  {
    id: 'bc_ruins_cathedral', regionId: 'region_ancient_ruins', name: '遗迹大殿', description: '宏伟的古代殿堂残骸，内部空间形成了奇异气流',
    icon: '🏛️', position: { x: 80, y: 160 }, unlockCost: 0, buildingCount: 3, minHeight: 35, maxHeight: 55, specialEffect: 'ancient_resonance', rewardCoins: 120,
  },
  {
    id: 'bc_stone_pillars', regionId: 'region_ancient_ruins', name: '石柱森林', description: '密集的石柱群，窄间距飞行考验精准操控',
    icon: '🗿', position: { x: 120, y: 130 }, unlockCost: 200, buildingCount: 10, minHeight: 20, maxHeight: 40, specialEffect: 'pillar_slalom', rewardCoins: 110,
  },
  {
    id: 'bc_underground_hall', regionId: 'region_ancient_ruins', name: '地下大厅', description: '隐藏在地下的巨大空腔，气流在此汇聚旋转',
    icon: '🕳️', position: { x: 100, y: 180 }, unlockCost: 250, buildingCount: 2, minHeight: 45, maxHeight: 65, specialEffect: 'vortex_chamber', rewardScore: 500, rewardCoins: 150,
  },
  {
    id: 'bc_cloud_palace', regionId: 'region_sky_island', name: '云中宫殿', description: '漂浮于云端的华丽宫殿，传说的风筝王曾居于此',
    icon: '🏰', position: { x: 400, y: 40 }, unlockCost: 0, buildingCount: 4, minHeight: 40, maxHeight: 70, specialEffect: 'cloud_lift', rewardCoins: 150,
  },
  {
    id: 'bc_sky_dock', regionId: 'region_sky_island', name: '天空码头', description: '岛屿间的连接通道，强风贯穿其间',
    icon: '🚁', position: { x: 450, y: 70 }, unlockCost: 300, buildingCount: 3, minHeight: 25, maxHeight: 45, specialEffect: 'crosswind', rewardCoins: 130,
  },
  {
    id: 'bc_wind_shrine', regionId: 'region_sky_island', name: '风之神殿', description: '最终的秘密地点，掌控着所有气流的起源',
    icon: '🎐', position: { x: 430, y: 30 }, unlockCost: 500, buildingCount: 2, minHeight: 50, maxHeight: 80, specialEffect: 'wind_origin', rewardScore: 1000, rewardCoins: 200,
  },
];
...
export const RARE_AIR_CURRENTS: RareAirCurrent[] = [
  {
    ...
    discoveryCondition: '在老城街区飞行距离超过300米', captureScore: 200, rewardCoins: 50,
  },
  {
    ...
    discoveryCondition: '在滨河走廊完成零碰撞飞行', captureScore: 350, rewardCoins: 80,
  },
  {
    ...
    discoveryCondition: '在滨河走廊达到150米高度', captureScore: 280, rewardCoins: 70,
  },
  {
    ...
    discoveryCondition: '在翠峰山脉达到250米高度', captureScore: 450, rewardCoins: 100,
  },
  {
    ...
    discoveryCondition: '在翠峰山脉捕获3个上升气流', captureScore: 500, rewardCoins: 120,
  },
  {
    ...
    discoveryCondition: '在翠峰山脉完成2次飞行', captureScore: 380, rewardCoins: 90,
  },
  {
    ...
    discoveryCondition: '在钢铁工坊得分超过3000', captureScore: 400, rewardCoins: 90,
  },
  {
    ...
    discoveryCondition: '在钢铁工坊探索2个建筑群', captureScore: 500, rewardCoins: 110,
  },
  {
    ...
    discoveryCondition: '在古迹遗迹完成剧情事件「古老传说」', captureScore: 600, rewardCoins: 130,
  },
  {
    ...
    discoveryCondition: '在古迹遗迹飞行距离超过800米', captureScore: 420, rewardCoins: 100,
  },
  {
    ...
    discoveryCondition: '在古迹遗迹探索3个建筑群', captureScore: 550, rewardCoins: 120,
  },
  {
    ...
    discoveryCondition: '在浮空群岛完成2次飞行', captureScore: 700, rewardCoins: 150,
  },
  {
    ...
    discoveryCondition: '在浮空群岛达到500米高度', captureScore: 1000, rewardCoins: 200,
  },
  {
    ...
    discoveryCondition: '在浮空群岛捕获3个稀有气流', captureScore: 800, rewardCoins: 180,
  },
  {
    ...
    discoveryCondition: '在浮空群岛得分超过10000', captureScore: 750, rewardCoins: 160,
  },
];
