...
export const MainMenu: React.FC<MainMenuProps> = ({ onStart, onWorkshop, onTournament, onTraining, onWeatherLab, onLevelEditor, onJourney, onFestival, onMapExplore, onReplay, onStageChallenge }) => {
  return (
